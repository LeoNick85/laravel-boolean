...
@section('content')
    <div id="faq-title" class="container-faq">
    ...
    <div id="faq-wrapper" class="clearfix">
        <div class="faq-box float-left">
            ...
            <div class="faq-element">
                ...
                <p>Chiunque abbia una forte curiosità verso il mondo della programmazione e voglia di imparare a fare il mestiere di sviluppatore.<br>
        ...
        <div class="faq-box float-left">
            ...
            <div class="faq-element">
                <div class="faq-question">
                    <h3>Terminato il corso, sono supportato nella ricerca del lavoro?</h3>
                    <i class="fas fa-plus"></i>
                </div>
                <p>Certamente! Verrai presentato a oltre 50 aziende che operano nel settore Internet in Italia. Dalla multinazionale più quotata alla startup in ascesa, avrai l’occasione di presentare te stesso e le tue qualità da neo-sviluppatore. Inoltre, ti affianchiamo nella costruzione del CV, del portfolio di progetti e simuliamo insieme dei colloqui: il tuo successo è il nostro!</p>
            </div>
            <div class="faq-element">
                <div class="faq-question">
            ...
            <div class="faq-element">
                <div class="faq-question">
                    <h3>Posso fare lo sviluppatore freelance al termine del corso?</h3>
                    <i class="fas fa-plus"></i>
                </div>
                <p>È una possibilità, ma sconsigliamo di intraprendere questa strada subito dopo il corso: per essere sviluppatori freelance l'esperienza è fondamentale e difficilmente sono sufficienti 6 mesi. Se il tuo obiettivo è lavorare seguendo i tuoi ritmi, la strada è quella giusta: molte aziende si stanno aprendo al work from home e, con un po' di esperienza in più, siamo certi che diventerai un ottimo sviluppatore freelance!</p>
            </div>
            <div class="faq-element">
                <div class="faq-question">
                    <h3>Troverò un lavoro nella mia città?</h3>
                    <i class="fas fa-plus"></i>
                </div>
                <p>Collaboriamo con tante aziende, ma non possiamo garantire un’opportunità di lavoro in una zona specifica: attualmente ci siamo concentrati sulle migliori aziende del settore, quelle che creano prodotti tecnologici di alta qualità e hanno team di sviluppo ben organizzati che permettono di fare esperienze formative. Certo è che, qualora le tue esigenze non combaciassero con le aree geografiche delle nostre aziende partner, sarà nostra cura aiutarti a ricercare soluzioni più vicine a te.</p>
            </div>
            <div class="faq-element">
                <div class="faq-question">
                    <h3>Che tipo di attestato rilasciate?</h3>
                    <i class="fas fa-plus"></i>
                </div>
                <p>Rilasciamo un attestato di frequenza che certifica il numero di ore di lezione frequentate e gli argomenti trattati (HTML, CSS, Javascript, MySql e PHP).</p>
            </div>
        </div>
    </div>
@endsection
